...
contract MixedAuthorityVault {
    ...
    function rotateRouteManager(address newRouteManager) external onlyOwner {
        routeManager = newRouteManager;
    }

    function emergencySweep(address replacementTreasury) external onlyOwner {
        treasury = replacementTreasury;
    }
}
